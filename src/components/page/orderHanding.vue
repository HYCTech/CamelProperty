        ...
        <div class="container">
            ...
            <div class="handle-box">
                ...
                <el-select v-model="select_cate" placeholder="请选择" class="handle-select mr10">
                    ...
                    <el-option key="2" label="接单员" value="staff_name"></el-option>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable"
                ...
                <el-table-column label="接单操作">
                    <template slot-scope="scope">
                        <div v-if="scope.row.order_state=='pending'">

                            <el-button type="text"
                                       @click="editOrderState(scope.$index, scope.row,true)">
                                待接单中
                            </el-button>
                            <!-- <el-button type="text" icon="el-icon-edit"
                                        @click="editOrderState(scope.$index, scope.row,false)">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            editOrderState(index, row, showPrimary) {



                const item = this.tableData[index];
                let staff_tel = item.staff_tel;//联系方式
                let staff_name = item.staff_name;//接单员
                //
                if(""==staff_name|| ""==staff_tel){
                    this.$confirm('请先在订单管理中确定接单员，再进行接单?', '提示', {
    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <div class="handle-box">
                ...
                <el-select v-model="select_cate" placeholder="请选择" class="handle-select mr10">
                    <el-option key="1" label="请选择" value=""></el-option>
                    <el-option key="2" label="地址" value="repair_place"></el-option>
                    <el-option key="3" label="姓名" value="staff_name"></el-option>
                    <el-option key="4" label="电话号码" value="staff_tel"></el-option>
                </el-select>
                <el-input v-model="select_word" placeholder="筛选关键词" class="handle-input mr10"></el-input>
                <el-button type="primary" icon="search" @click="search">搜索</el-button>
        ...
        <el-dialog title="订单派送" :visible.sync="editVisible" @close='closeDistribution'>
            ...
            <div slot="footer" class="dialog-footer">
                <div v-if="primaryVisble">
                    <el-button @click="closeDistribution">取 消</el-button>
                    <el-button  @click="print" >打印</el-button>
                    &lt;!&ndash;<el-button  v-print="'#printTest'">打印</el-button>&ndash;&gt;
                </div>
                <div v-else>
                    <el-button @click="editVisible = false">取 消</el-button>
                    <el-button type="primary" @click="saveEdit">确 定</el-button>
